...
class ChatItemDecoration:RecyclerView.ItemDecoration() {
    override fun getItemOffsets(
        ...
        val margin32=parent.context.resources.getDimensionPixelSize(R.dimen.margin32)

        val newRect=when(position){
            0->Rect(margin16,margin32,margin16,margin8)
            state.itemCount-1->Rect(margin16,margin8,margin16,margin32)
